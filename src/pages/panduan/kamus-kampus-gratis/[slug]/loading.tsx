...
const LoadingGuideDictionaryDetail: FC = (): ReactElement => {
  return (
    <div className="mt-36">
      {/* breadcrumb */}
      ...
      <div className="animate-pulse w-full flex flex-col-reverse lg:flex-row ">
        ...
        <div className="flex flex-col lg:-ml-20 md:px-10 px-5 mt-[30px] mb-[50px]">
          <div className="col-span-1 ">
            ...
            <div className=" bg-neutral-200 w-full py-10 rounded-lg flex justify-center px-20 mt-5"></div>
          </div>
        </div>
      </div>
    </div>
...
export default LoadingGuideDictionaryDetail;
