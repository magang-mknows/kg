...
import { guideDictionaryProgramStudi } from "@/utilities/constant";
import Card from "@/components/Common/Card";

const KamusDetail: FC = (): ReactElement => {
  return (
    <BaseLayoutsLanding>
      <BreadCrumb items={guideDictionaryProgramStudi} />
        ...
        <div className="flex flex-col px-6 md:px-8 lg:px10 mt-[30px] mb-[50px]">
          ...
          >
            <div className="flex flex-col mt-[12px] gap-4 text-sm">
              <p>
                Kesatuan rencana belajar sebagai pedoman penyelenggaraan pendidikan akademik dan
                atau profesional atas dasar suatu kurikulum.
              </p>
            </div>
          </Card>
        </div>
