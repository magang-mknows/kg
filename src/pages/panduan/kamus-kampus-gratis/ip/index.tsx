...
import { guideDictionaryIP } from "@/utilities/constant";
import Card from "@/components/Common/Card";

const KamusDetail: FC = (): ReactElement => {
  return (
    <BaseLayoutsLanding>
      <BreadCrumb items={guideDictionaryIP} />
        ...
        <div className="flex flex-col px-6 md:px-8 lg:px10 mt-[30px] mb-[50px]">
          ...
          >
            <div className="flex flex-col mt-[12px] gap-4 text-sm">
              <p>
                Adalah singkatan dari “Indeks Prestasi,” yang artinya sama aja kayak nilai akhir
                semester.
              </p>
            </div>
          </Card>
