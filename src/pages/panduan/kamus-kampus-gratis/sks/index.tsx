...
import { guideDictionarySKS } from "@/utilities/constant";
import Card from "@/components/Common/Card";

const KamusDetail: FC = (): ReactElement => {
  return (
    <BaseLayoutsLanding>
      <BreadCrumb items={guideDictionarySKS} />
        ...
        <div className="flex flex-col px-6 md:px-8 lg:px10 mt-[30px] mb-[50px]">
          ...
          >
            <div className="flex flex-col mt-[12px] gap-4 text-sm">
              <p>
                Nilai keseluruhan mahasiswa dari beban studi yang ia ambil. IPK digunakan sebagai
