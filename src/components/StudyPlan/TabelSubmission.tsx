        ...
        <div className="grid grid-cols-12 overflow-auto whitespace-nowrap mx-auto border bg-gray-100 border-gray-200 rounded-lg divide-neutral-400 dark:divide-gray-700 w-full text-[16px]">
          ...
          {tabel.map((x, i) => (
            <>
              ...
              <div className="flex gap-2 bg-gray-100 border-t border-[#E5E5E5] dark:divide-gray-700 lg:text-start text-center py-3 font-medium col-span-2 md:text-[16px] lg:text-[16px] text-[12px] dark:bg-transparent">
              {x.keterangan === "Disetujui" ? (
                    <svg
                      width="21"
                      height="22"
