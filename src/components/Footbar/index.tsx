  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            lg:ml-16"
          >
            <h6 className="mb-4 flex text-black text-2xl font-bold">Fitur</h6>
          ...
          <div className="text-start">
            <h6 className="mb-4 flex text-black text-2xl font-bold md:justify-start">Kontak</h6>

            <p className="mb-2 mt-8">
              <a className="text-gray-400">Telp : </a>
              <a className="">0217209729 </a>
            </p>
            <p className="mb-2">
              <a className="text-gray-400">Email : </a>
              <a className="">learning@m-knowsconsulting.com </a>
            </p>
          </div>
          ...
          <div className="text-start">
            <h6 className="mb-4 flex text-black text-2xl font-bold md:justify-start">Alamat</h6>

            <p className="mb-2 mt-8">
              <a className="text-gray-400">Utama : </a>
              <a className="">
            ...
            <p className="mb-2">
              <a className="text-gray-400">Cabang : </a>
              <a className="">
            ...
            <p className="mb-2">
              <a className="text-gray-400">Cabang : </a>
              <a className="">Jl. Raya Darmo Permai III Surabaya. 60119</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        justify-between"
      >
        <div>2022 - www.kampusgratis.id - Hak Cipta Dilindungi.</div>
        <div
          className="
            flex 
            justify-center 
