      ...
      <section className="lg:px-0 md:px-10 px-5 py-3 w-full mt-[36px] drop-shadow-md mb-3 min-h-screen">
        ...
        <div className="flex flex-row gap-10">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="flex flex-col mb-20 lg:justify-start md:justify-around justify-center md:gap-10 lg:gap-20 gap-5 mt-10 ml-10 animate-pulse bg-neutral-100 w-[381px] rounded-lg "
            >
