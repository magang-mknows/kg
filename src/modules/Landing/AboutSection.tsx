...
const AboutSection: FC = (): ReactElement => {
  return (
    <MainLayouts className="grid grid-col-1 lg:grid-cols-1 md:grid-cols-1 gap-y-5 gap-x-10 py-5 px-[10%] h-screen">
      <ContentLayouts>
        <div className="grid grid-cols-1 text-[#f9feff] md:grid-cols-1 lg:grid-cols-5 dark:text-[#f9feff] gap-6">
          {/* image */}
          ...
          <div className="lg:col-span-3 md:w-auto">
            <div className="grid grid-col-1 grid-flow-row md:grid-flow-col md:grid-cols-2 ">
              <Card
                ...
                hasImage={false}
                icon={
                  <FiPower className="text-2xl text-[#fd7e14] inline-block bg-[#fff2e7] dark:bg-[#392e27] rounded-md p-4 w-14 h-14" />
                }
                titleStyle={"text-xl font-bold mt-1"}
                title={"Online Learning"}
                children={
                  <p className="text-gray-500 mt-2">
                    Mulailah meningkatkan pengetahuan dan kemampuan Anda melalui fitur online
                    learning kami yang menawarkan pengalaman belajar yang interaktif dan
                    menyenangkan.
                  </p>
                }
              />
              <Card
                ...
                hasImage={false}
                icon={
                  <FiPower className="text-2xl text-[#17a2b8]  inline-block bg-[#e7f6f8] dark:bg-[#213238] rounded-md p-4 w-14 h-14" />
                }
                titleStyle={"text-xl font-bold mt-1"}
                title={"Gamifikasi"}
                children={
            ...
            <div className="grid grid-col-1 grid-flow-row md:grid-flow-col lg:grid-cols-2 md:grid-cols-2">
              <Card
                ...
                hasImage={false}
                icon={
                  <FiPower className="text-2xl text-[#0cbc87] inline-block bg-[#e6f8f3] dark:bg-[#203433] rounded-md p-4 w-14 h-14" />
                }
                titleStyle={"text-xl font-bold mt-1"}
                title={"E-Serifikat"}
                children={
                  <p className="text-gray-500 mt-2">
                    ...
                    E-sertifikat kami yang memberikan sertifikat berkualitas tinggi dan dapat
              ...
              <Card
                ...
                hasImage={false}
                icon={
                  <FiPower className="text-2xl text-[#d6293e] inline-block bg-[#fbe9eb] dark:bg-[#35252b] rounded-md p-4 w-14 h-14" />
                }
                titleStyle={"text-xl font-bold mt-1"}
