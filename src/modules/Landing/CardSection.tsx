...
const CardSection: FC = (): ReactElement => {
  return (
    <div>
      <div className="flex flex-col lg:flex-row w-full h-auto justify-center lg:justify-between bg-[#106FA4] h-[306px] md:h-[100px] lg:h-[120px] z-[40] lg:px-20 mt-2 items-center">
