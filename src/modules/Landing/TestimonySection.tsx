...
const TestimonySection: FC = (): ReactElement => {
  return (
    <section className="mt-40 w-full mx-8 px-6 md:px-8 lg:mx-0 lg:px-10 py-10 lg:py-20 flex justify-self-center bg-[#f5f5f5] dark:bg-gray-800">
      <div className="flex flex-col xl:flex-row w-full xl:gap-x-20 gap-y-12 h-fit">
        <div className="flex flex-col justify-center px-20 items-center text-center gap-y-9 md:items-start md:text-start">
          <p className=" text-2xl text-[#808080]">TESTIMONI</p>
        ...
        <div className="grid pr-12 grid-cols-[320px_320px] gap-x-[30px] overflow-x-scroll md:overflow-visible snap-mandatory">
