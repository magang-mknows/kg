...
const HeroSection: FC = (): ReactElement => {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row xl:flex-row lg:flex-row w-full justify-center lg:justify-between bg-[#106FA4] h-[300px] md:h-[100px] lg:h-[140px] mt-[-220px] xl:mt-[-234px] lg:mt-[-234px] z-50 lg:px-40 font-normal px-[20%] md:px-[40%] ">
