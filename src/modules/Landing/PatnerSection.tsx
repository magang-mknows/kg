...
const MitraSection: FC = (): ReactElement => {
  return (
    <div className="flex flex-col mb-10 overflow-hidden">
      <div className="lg:mb-10 flex gap-2 lg:justify-center justify-start items-start lg:items-center">
        <p className="flex gap-2 title text-[35px] md:text-[40px] lg:text-5xl font-bold text-[#262626] bg-white dark:text-white justify-center w-full">
