...
const MitraSection: FC = (): ReactElement => {
  return (
    <div className="flex flex-col lg:mb-10 mb-10 overflow-hidden">
      <div className="lg:mb-10 mb-2 flex gap-2 lg:justify-center justify-start items-start lg:items-center dark:bg-gray-600">
        <p className="flex gap-2  lg:pt-20 pt-10 title text-[35px] md:text-[40px] lg:text-5xl font-bold text-[#262626] bg-white justify-center w-full">
