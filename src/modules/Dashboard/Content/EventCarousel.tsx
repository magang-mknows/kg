          ...
          <div key={index} className={`${item.id === getSelectedEvent ? "block" : "hidden"}`}>
                ...
                <section className="flex gap-4">
                  <div className="flex flex-col ">
                    ...
                    <section className="flex gap-2 items-center">
                      ...
                      <p className="text-sm text-neutral-400">{item.totalSpeakers} Pemateri</p>
                    </section>
                  </div>
                  <div className="flex flex-col ">
                    <section className="flex gap-2 items-center mb-2">
            ...
            <section className="flex justify-between items-center">
              <Button
                ...
                className="text-white bg-yellow-500 text-sm py-2 px-4 rounded-md hover:bg-yellow-600 transition-colors ease-in-out duration-300"
              />
            </section>
          </div>
        );
