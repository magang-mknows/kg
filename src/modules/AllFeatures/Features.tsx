...
const DataFitur: { id: number; namaFitur: string; icon: StaticImageData; warna: string; slug: string }[] = [
  ...
  { id: 4, namaFitur: "Nilai dan Sertifikat", icon: icon3, warna: "#E3FBDA", slug: "/nilai-sertifikat"  },
  ...
  { id: 7, namaFitur: "Konsultasi & Layanan", icon: icon2, warna: "#FEF6D0", slug: "/konsultasi-dan-layanan"  },
  { id: 8, namaFitur: "Simulasi, Drill & Assessmen", icon: icon6, warna: "#E9F6FD", slug: "/drill-simulasi"  },
  ...
  { id: 15, namaFitur: "Perencanaan Karir", icon: icon11, warna: "#E3FBDA", slug: "/perencanaan-karir"  },
  { id: 16, namaFitur: "Penyaluran Kerja", icon: icon12, warna: "#FEF6D0", slug: "/penyaluran-kerja"  },
];
        ...
        <div className="grid grid-cols-12 gap-x-[40px] gap-y-[34px]">
          {DataFitur.map((fitur) => {
            return (
              ...
              <Card href={fitur.slug} hasImage={true} src={fitur.icon} imgStyle="w-[80px] mx-auto">
