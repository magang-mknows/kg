    ...
    <div className="flex flex-col">
      ...
      >
        <GlobalButton
          ...
          size="regular"
          className=" bg-green-500 hover:bg-green-600 cursor-pointer transition-colors ease-in-out duration-300 shadow-md text-sm flex relative items-center justify-center text-white dark:bg-primary-500"
        />
      </div>
    </div>
  );
